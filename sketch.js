...
mainCyclist.scale=0.06;
  mainCyclist.addAnimation ("ola",mainRacerImg2);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textFont ("verdana")
    textSize (18);
    text ("Clique no buraco para perder de novo",500,280);
  restart.visible = true ;
  
    path.velocityX = 0;
    mainCyclist.velocityY = 0;
    mainCyclist.changeAnimation("ola",mainRacerImg2);
...
pinkCG.destroyEach ();
 mainCyclist.changeAnimation ("ShailRunning",mainRacerImg1,);
distance = 0
}
